...
4. **Add a pipeline test suite.** `tests/run-checks.sh` provides 165 static
...
| 2 | ◑ Static check gate exists (`tests/run-checks.sh`, 165 checks). Still needs a pipeline smoke test | Stage 1 |
