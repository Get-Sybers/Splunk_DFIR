...
/******/ 	return __webpack_require__(__webpack_require__.s = "./package/appserver/static/components/pages/showcase_soar.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./package/appserver/static/components/pages/showcase_soar.js":
/***/ (function(module, exports, __webpack_require__) {
...
require(['jquery', 'splunkjs/mvc/simplexml/controller', 'components/controls/Modal'], function ($, DashboardController, Modal) {
  var triggerModal = function triggerModal(bodycontent) {
    ...
    myModal.body.addClass('mlts-modal-form-inline').append($(bodycontent));
...
require(["jquery", "underscore", "splunkjs/mvc", "splunkjs/mvc/chartview", "splunkjs/mvc/dropdownview", "splunkjs/mvc/textinputview", "splunkjs/mvc/singleview", "splunkjs/mvc/checkboxview", "splunkjs/mvc/tableview", "splunkjs/mvc/utils", 'splunkjs/mvc/visualizationregistry', 'Options', "components/splunk/Forms", "components/splunk/KVStore", 'components/splunk/SearchBarWrapper', "components/splunk/Searches", "components/data/parameters/ParseSearchParameters", "components/data/formatters/compactTemplateString", "components/data/serializers/ShowcaseHistorySerializer", "components/controls/AssistantControlsFooter", "components/controls/AssistantPanel/Master", "components/controls/QueryHistoryTable", "components/controls/SearchStringDisplay", "components/controls/DrilldownLinker", "components/controls/Messages", "components/controls/Modal", "components/controls/Spinners", "components/controls/Tabs", "components/controls/ProcessSummaryUI", "components/data/sampleSearches/SampleSearchLoader", "components/data/validators/NumberValidator", "splunkjs/mvc/searchmanager", 'json!' + $C['SPLUNKD_PATH'] + '/services/SSEShowcaseInfo?locale=' + window.localeString], function ($, _, mvc, ChartView, DropdownView, TextInputView, SingleView, CheckboxView, TableView, utils, VisualizationRegistry, Options, Forms, KVStore, SearchBarWrapper, Searches, ParseSearchParameters, compact, ShowcaseHistorySerializer, AssistantControlsFooter, AssistantPanel, QueryHistoryTable, SearchStringDisplay, DrilldownLinker, Messages, Modal, Spinners, Tabs, ProcessSummaryUI, SampleSearchLoader, NumberValidator, SearchManager, ShowcaseInfo) {
  Promise.resolve(/* AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("./node_modules/bootstrap/js/src/tooltip.js"), __webpack_require__("./node_modules/bootstrap/js/src/popover.js")]; (function () {
    var _context;
    var showcaseName = 'showcase_custom';
    var appName = Options.getOptionByName('appName');
    var ShowcaseId = "soar_covid_19_indicator_check";
    if ((0, _indexOf["default"])(_context = location.href).call(_context, "?showcaseId=") >= 0) {
      var _context2;
      var hash = location.href.split("?")[1];
      var params = {};
      (0, _map["default"])(_context2 = hash.split('&')).call(_context2, function (hk) {
        var temp = hk.split('=');
    ...
    ProcessSummaryUI.process_chosen_summary_async($, ShowcaseInfo['summaries'][ShowcaseId], "", ShowcaseInfo, ShowcaseId, showcaseName);
