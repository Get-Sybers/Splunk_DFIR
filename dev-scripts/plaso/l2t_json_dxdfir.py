...
A drop-in psort output module (`-o l2t_json_dxdfir`) that emits the same rich,
...
Copy this file into the container and run, e.g.:
  ...
  psort.py -o l2t_json_dxdfir --output_fallback_hostname -w out.jsonl storage.plaso
