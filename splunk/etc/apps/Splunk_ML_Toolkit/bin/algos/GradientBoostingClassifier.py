...
from codec.codecs import SimpleObjectCodec, NoopCodec
...
class GradientBoostingClassifier(ClassifierMixin, BaseAlgo):
    ...
    def register_codecs():
        ...
        codecs_manager.add_codec('sklearn._loss.loss', 'HalfMultinomialLoss', SimpleObjectCodec)
        codecs_manager.add_codec('_loss', 'CyHalfMultinomialLoss', NoopCodec)
        codecs_manager.add_codec('sklearn._loss.link', 'MultinomialLogit', SimpleObjectCodec)
        codecs_manager.add_codec('sklearn._loss.link', 'Interval', SimpleObjectCodec)
        codecs_manager.add_codec('sklearn._loss.loss', 'ExponentialLoss', SimpleObjectCodec)
        codecs_manager.add_codec('_loss', 'CyExponentialLoss', NoopCodec)
        codecs_manager.add_codec('sklearn._loss.link', 'HalfLogitLink', SimpleObjectCodec)
